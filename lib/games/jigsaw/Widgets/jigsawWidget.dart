...
import 'package:docapp/games/jigsaw/Models/blockClass.dart';
import 'package:docapp/games/jigsaw/Models/imageBox.dart';
import 'package:docapp/games/jigsaw/Models/jigsawPos.dart';
import 'package:docapp/games/jigsaw/Utils/jigsaw_painter.dart';
  ...
  Future<void> generalJigsawCropImage() async {
    ...
    for (var y = 0; y < ySplitCount; y++) {
      ...
      for (var x = 0; x < xSplitCount; x++) {
        ...
        // ui.Image teme=ui.copyCrop(fullImage, x: xAxis.round(), y: y, width: width, height: height)
