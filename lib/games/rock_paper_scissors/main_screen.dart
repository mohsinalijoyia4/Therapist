...
import 'package:docapp/games/rock_paper_scissors/results_screen.dart';
import 'package:flutter/material.dart';

class MainScreenRock extends StatefulWidget {
  const MainScreenRock({Key? key}) : super(key: key);

  @override
  _MainScreenRockState createState() => _MainScreenRockState();
}

class _MainScreenRockState extends State<MainScreenRock> {
  @override
                      ...
                      child: Hero(
                        ...
                        child: gameBtn(() {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  GameScreenRocks(GameChoice("Rock")),
                            ),
                          );
                      ...
                      child: Hero(
                        ...
                        child: gameBtn(() {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  GameScreenRocks(GameChoice("Scisors")),
                            ),
                          );
                      ...
                      child: Hero(
                        ...
                        child: gameBtn(() {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  GameScreenRocks(GameChoice("Paper")),
                            ),
                          );
